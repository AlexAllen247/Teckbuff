            ...
            <Navbar.Collapse id="basic-navbar-nav justify-content-center">
              <div className="mx-auto">
                <Nav className="me-auto mt-2 justify-content-center">
                  ...
                  <Nav.Link href="/portfolio" style={navStyle}>
                    Portfolio
                  </Nav.Link>
                  <Nav.Link href="/certifications" style={navStyle}>
                    Certifications
                  </Nav.Link>
                  ...
                  <Nav.Link href="/videos" style={navStyle}>
                    Videos
                  </Nav.Link>
                  <Nav.Link href="/contactforms" style={navStyle}>
                    Contact
                  </Nav.Link>
                  <a
