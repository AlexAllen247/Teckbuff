        ...
        <div className="container-fluid">
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto mt-2">
              ...
              <Nav.Link href="/portfolio" style={navLinkStyle}>
                Portfolio
              </Nav.Link>
              <Nav.Link href="/certifications" style={navLinkStyle}>
                Certifications
              </Nav.Link>
              ...
              <Nav.Link href="/videos" style={navLinkStyle}>
                Videos
              </Nav.Link>
              <Nav.Link href="/contactforms" style={navLinkStyle}>
                Contact
              </Nav.Link>
            <a
